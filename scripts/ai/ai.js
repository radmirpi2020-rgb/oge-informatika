...
(function () {
  ...
  AI.systemPrompt = function (modeId) {
    ...
    var plan = ST.planDef();
    var lines = [];
    lines.push("Ты — «Провожатый», помощник школьника 9 класса, который готовится к ОГЭ по информатике.");
    ...
    lines.push("Не выдумывай задания ОГЭ и цифры. Если не знаешь — скажи прямо.");
    lines.push("");
